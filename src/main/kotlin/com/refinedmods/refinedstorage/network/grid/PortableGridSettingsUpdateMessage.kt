...
class PortableGridSettingsUpdateMessage(private val viewType: Int, private val sortingDirection: Int, private val sortingType: Int, private val searchBoxMode: Int, private val size: Int, private val tabSelected: Int, private val tabPage: Int) {
    companion object {
        fun decode(buf: PacketByteBuf): PortableGridSettingsUpdateMessage {
            return PortableGridSettingsUpdateMessage(
                    buf.readInt(),
                    buf.readInt(),
                    buf.readInt(),
                    buf.readInt(),
        ...
        fun encode(message: PortableGridSettingsUpdateMessage, buf: PacketByteBuf) {
        ...
        fun handle(message: PortableGridSettingsUpdateMessage, ctx: Supplier<NetworkEvent.Context>) {
