...
class OneKStoragePartItem : Item(Settings().group(MyItemGroups.CURED_STORAGE))

@RegisterItem(RS.ID, "4k_storage_part")
class FourKStoragePartItem : Item(Settings().group(MyItemGroups.CURED_STORAGE))

@RegisterItem(RS.ID, "16k_storage_part")
class SixteenKStoragePartItem : Item(Settings().group(MyItemGroups.CURED_STORAGE))

@RegisterItem(RS.ID, "64k_storage_part")
class SixtyFourKStoragePartItem : Item(Settings().group(MyItemGroups.CURED_STORAGE))
