...
public class FilterScreen extends BaseScreen<FilterContainer> {
    ...
    private void updateModeButton(int mode) {
        ITextComponent text = mode == IFilter.MODE_WHITELIST ? new TranslationTextComponent("sidebutton.refinedstorage.mode.whitelist") : new TranslationTextComponent("sidebutton.refinedstorage.mode.blacklist");
    ...
    public void renderForeground(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        renderString(matrixStack, 7, 137, new TranslationTextComponent("container.inventory").getString());
    }
