...
public class CraftingPreviewScreen extends BaseScreen<Container> {
    ...
    public void renderForeground(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        if (getErrorType() != null) {
            ...
            renderString(matrixStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 11, scale), new TranslationTextComponent("gui.refinedstorage.crafting_preview.error").getString());

            switch (getErrorType()) {
                case RECURSIVE: {
                    renderString(matrixStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 21, scale), new TranslationTextComponent("gui.refinedstorage.crafting_preview.error.recursive.0").getString());
                    renderString(matrixStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 31, scale), new TranslationTextComponent("gui.refinedstorage.crafting_preview.error.recursive.1").getString());
                    renderString(matrixStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 41, scale), new TranslationTextComponent("gui.refinedstorage.crafting_preview.error.recursive.2").getString());
                    renderString(matrixStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 51, scale), new TranslationTextComponent("gui.refinedstorage.crafting_preview.error.recursive.3").getString());

                    renderString(matrixStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 61, scale), new TranslationTextComponent("gui.refinedstorage.crafting_preview.error.recursive.4").getString());
                ...
                case TOO_COMPLEX: {
                    renderString(matrixStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 21, scale), new TranslationTextComponent("gui.refinedstorage.crafting_preview.error.too_complex.0").getString());
                    renderString(matrixStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 31, scale), new TranslationTextComponent("gui.refinedstorage.crafting_preview.error.too_complex.1").getString());
