...
public abstract class BaseScreen<T extends Container> extends ContainerScreen<T> {
    ...
    public void renderTooltip(MatrixStack matrixStack, int x, int y, String lines) {
        renderTooltip(ItemStack.EMPTY, matrixStack, x, y, lines);
    }

    public void renderTooltip(@Nonnull ItemStack stack, MatrixStack matrixStack, int x, int y, String lines) {
        renderTooltip(stack, matrixStack, x, y, Arrays.stream(lines.split("\n")).map(StringTextComponent::new).collect(Collectors.toList()));
    }

    public void renderTooltip(@Nonnull ItemStack stack, MatrixStack matrixStack, int x, int y, List<ITextComponent> lines) {
