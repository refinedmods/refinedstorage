...
public abstract class AmountSpecifyingScreen<T extends Container> extends BaseScreen<T> {
    ...
    public void onPostInit(int x, int y) {
        ...
        okButton = addButton(x + pos.getLeft(), y + pos.getRight(), getOkCancelButtonWidth(), 20, new StringTextComponent(getOkButtonText()), true, true, btn -> onOkButtonPressed(hasShiftDown()));
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            addButton(x + xx, y + 20, width, 20, new StringTextComponent(text), true, true, btn -> onIncrementButtonClicked(increment));
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            addButton(x + xx, y + ySize - 20 - 7, width, 20, new StringTextComponent(text), true, true, btn -> onIncrementButtonClicked(-increment));
