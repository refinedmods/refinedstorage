...
public class PortableGridBlockLootFunction extends LootFunction {
    protected PortableGridBlockLootFunction(ILootCondition[] conditionsIn) {
        super(conditionsIn);
    }
    ...
    public LootFunctionType func_230425_b_() {
        return CommonSetup.LOOTFUNCTION_PORTABLEGRID;
    }

    public static class Serializer extends LootFunction.Serializer<PortableGridBlockLootFunction> {

        @Override
        public PortableGridBlockLootFunction deserialize(JsonObject object, JsonDeserializationContext deserializationContext, ILootCondition[] conditionsIn) {
            return new PortableGridBlockLootFunction(conditionsIn);
        }
    }
