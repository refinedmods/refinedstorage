...
public final class RenderUtils {
    ...
    public static void drawTooltipWithSmallText(MatrixStack matrixStack, List<ITextProperties> textLines, List<String> smallTextLines, boolean showSmallText, @Nonnull ItemStack stack, int mouseX, int mouseY, int screenWidth, int screenHeight, FontRenderer fontRenderer) {
    ...
    public static List<String> getTooltipFromItem(ItemStack stack) {
        ...
        for (ITextComponent itextcomponent : tooltip) {
            tooltipStrings.add(itextcomponent.getString());
        }
