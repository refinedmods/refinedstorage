...
import com.raoulvdberge.refinedstorage.render.teisr.PatternOutputTileEntityRenderer;
...
public class ItemPattern extends ItemBase implements ICraftingPatternProvider {
    ...
    public ItemPattern() {
        ...
        setTileEntityItemStackRenderer(PatternOutputTileEntityRenderer.instance);
    }
