...
public class GuiExporter extends GuiBase {
    ...
    public void init(int x, int y) {
        ...
        if(IntegrationForestry.isLoaded()) {
            addSideButton(new SideButtonCompare(this, TileExporter.COMPARE, IComparer.COMPARE_FORESTRY | IntegrationForestry.Tag.GEN.getFlag() | IntegrationForestry.Tag.IS_ANALYZED.getFlag()));
        }
